  ...
  return (
    <Container as="section" id="contacto" className="bg-background">
      <div className="text-center mb-12">
        <h2 className="text-3xl sm:text-4xl font-bold font-headline text-primary">Contacta con Nosotros</h2>
        <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
          ¿Tienes alguna pregunta o necesitas un servicio? Rellena el formulario o contáctanos directamente. Estamos aquí para ayudarte.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-5 gap-12 items-start">
        ...
        <div className="md:col-span-2 space-y-8 bg-secondary/50 p-6 sm:p-8 rounded-xl shadow-lg">
          <div>
            ...
            <a href="mailto:info@alhaurintech.com" className="text-muted-foreground hover:text-accent transition-colors block">info@alhaurintech.com</a>
          </div>
          <div>
            <h3 className="text-xl font-semibold font-headline text-primary mb-3 flex items-center gap-2">
          ...
          <div>
            <h3 className="text-xl font-semibold font-headline text-primary mb-3">Horario de Atención</h3>
