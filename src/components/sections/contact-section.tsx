    ...
    <Container as="section" id="contacto" className="bg-background">
      <div className="text-center mb-12">
        ...
        <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
          ¿Tiene alguna pregunta o necesita ayuda con su tecnología? Rellene el formulario o contáctenos directamente. En Alhaurín Tech Solutions estamos para ayudarle.
        </p>
      </div>
