      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-12 items-center">
        <div className="text-center md:text-left">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold font-headline text-primary tracking-tight">
            Soluciones Tecnológicas <span className="block sm:inline text-foreground/80">a tu Alcance</span>
          </h1>
          <p className="mt-6 text-lg sm:text-xl text-muted-foreground max-w-xl mx-auto md:mx-0">
            Tu experto informático en Alhaurín el Grande y provincia de Málaga. Ofrecemos reparación, configuración y asesoramiento para todos tus dispositivos.
          </p>
        ...
        <div className="relative h-72 md:h-auto md:min-h-[450px] rounded-xl overflow-hidden shadow-2xl group">
          <Image
            ...
            alt="Técnico informático trabajando con un portátil"
            layout="fill"
            objectFit="cover"
